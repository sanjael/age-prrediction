...
|  2. Model A: EffNetV2-S (DEX Head)    |     |    Sanjayramdata/celingfan            |
|  3. Model B: EffNetV2-S (Hybrid Head) |     |  • Inference Endpoint / Spaces API    |
|  4. Dual Ensemble Fusion              |     |  • Authentication Bearer Token        |
|  5. Output: Age (4.18y) + Cohort      |     |                                       |
+---------------------------------------+     +---------------------------------------+
```
